      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            _id = req.params._id;
            _context.next = 8;
            return _allModel.OrderModel.findOne({
              user: _id
            });
...
Router.post("/new/:_id", _passport["default"].authenticate("jwt"), /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _id, orderDetails, addNewOrders;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 5;
            return _allModel.OrderModel.findOneAndUpdate({
              user: _id
            }, {
              $push: {
              ...
              "new": true
            } //to make this function return updated value
            );

          case 5:
            addNewOrders = _context2.sent;
