      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return _allModel.ReviewModel.find({
              restaurant: resid
            });
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 6;
            return _allModel.ReviewModel.create(_objectSpread(_objectSpread({}, reviewData), {}, {
              user: _id
            }));

          case 6:
            return _context2.abrupt("return", res.json({
              reviews: "Sucessfully created review"
            }));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            _id = req.params._id;
            _context3.next = 6;
            return _allModel.ReviewModel.findByIdAndDelete({
              _id: _id
            });

          case 6:
            return _context3.abrupt("return", res.json({
              reviews: "Sucessfully deleted review"
            }));
