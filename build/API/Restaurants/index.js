      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            city = req.query.city;
            _context.next = 4;
            return _allModel.RestaurantModel.find({
              city: city
            });

          case 4:
            restraunats = _context.sent;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            _id = req.params._id;
            _context2.next = 6;
            return _allModel.RestaurantModel.findById({
              _id: _id
            });

          case 6:
            restraunat = _context2.sent;
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            return _context3.abrupt("return", res.status(404).json({
              error: "No restraunt matched with ".concat(searchString)
            }));

          case 10:
            return _context3.abrupt("return", res.json(restaurants[0]._id));
