      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _allModel.userModel.findByEmailAndPhone(req.body.credentials);

          case 3:
            _context.next = 5;
            return _allModel.userModel.create(req.body.credentials);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            _context2.next = 5;
            return _allModel.userModel.findByEmailAndPassword(req.body.credentials);
